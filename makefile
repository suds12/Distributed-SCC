...
cuda: gpu_funcs.cu
	nvcc -o set_ex -c gpu_funcs.cu -I$(stdgpu)/include -I$(boost) -L$(stdgpu)/lib/ -lstdgpu 

combine:
	$(CC) main set_ex -o main_c -L$(cuda_base)/lib64 -lcudart -L$(stdgpu)/lib/ -lstdgpu 
...
cuda_run:
	$(run) -np 3 ./main_c input/distributed/g2/input_test input/distributed/g2/sccmap_test input/distributed/g2/change_test 2 1 input/distributed/g2/partition 3
